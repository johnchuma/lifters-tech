  ...
  return (
    <section className="relative pt-32 pb-20 flex items-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 text-center w-full">
        <span className="inline-flex items-center gap-2 bg-blue-700/20 border border-blue-500/40 text-blue-300 text-xs font-bold tracking-[0.2em] uppercase px-4 py-2 rounded-full mb-6 backdrop-blur-sm">
          {label}
        </span>
